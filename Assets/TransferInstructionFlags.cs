...
public enum TransferInstructionFlags
{
    ...
    DontSaveHierarchyView                   = 1 << 17,
    EditorPlayMode                          = 1 << 18,
    BuildResourceImage                      = 1 << 19,
    AssetBundleCollectDependencies          = 1 << 20,
    AssetBundleIncludeCompleteAssets        = 1 << 21,
    GenerateBakedPhysicsMeshes              = 1 << 22,
